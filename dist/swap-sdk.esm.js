...
import { hexDataSlice, concat, hexDataLength, isHexString, arrayify } from '@ethersproject/bytes';
import '@ethersproject/bignumber';
import { keccak256 } from '@ethersproject/keccak256';
import '@ethersproject/rlp';
...
var _SOLIDITY_TYPE_MAXIMA, _FACTORY_ADDRESSES, _INIT_CODE_HASHES, _PAIR_ADDRESSES;
var ChainId;
...
var FACTORY_ADDRESSES = (_FACTORY_ADDRESSES = {}, _FACTORY_ADDRESSES[ChainId.NILE] = '0x227044d0cd57e257b15c8c3bd5608e241b8b02ca', _FACTORY_ADDRESSES[ChainId.MAINNET] = '0x28d6a74c2e3a4da074011afef9238b59cf4fd825', _FACTORY_ADDRESSES[ChainId.SHASTA] = '0xb9fe040dd98a9718805c976f8a899ef17b0f43ed', _FACTORY_ADDRESSES);
var INIT_CODE_HASHES = (_INIT_CODE_HASHES = {}, _INIT_CODE_HASHES[ChainId.NILE] = '0xf18ab5ba2b2ea93d5f80bbf9f1f4b2ccc8ad443571e6a3af023346a5dd669249', _INIT_CODE_HASHES[ChainId.MAINNET] = '0xd81a8b57892d57f214f7ee297a246d0c81ad5dd2d7621668ea1705ea13da2f25', _INIT_CODE_HASHES[ChainId.SHASTA] = '0x515ceede630d54ea899e245e075fe1f8d2574639cfb3fbc20c70fa8b8d9bb884', _INIT_CODE_HASHES); // @TRON
...
function buildPairAddresses(list) {
  ...
  list.forEach(function (_ref) {
    ...
    var _ref2 = tokenA.toLowerCase() < tokenB.toLowerCase() ? [tokenA, tokenB] : [tokenB, tokenA],
        token0_ = _ref2[0],
        token1_ = _ref2[1];

    var token0 = token0_.toLowerCase();
    var token1 = token1_.toLowerCase();
...
var PAIR_ADDRESSES = (_PAIR_ADDRESSES = {}, _PAIR_ADDRESSES[ChainId.NILE] = /*#__PURE__*/buildPairAddresses([[// DTKN/WTRX
...
]]), _PAIR_ADDRESSES[ChainId.MAINNET] = /*#__PURE__*/buildPairAddresses([[// USDT/EOTC
...
// ]
]), _PAIR_ADDRESSES[ChainId.SHASTA] = /*#__PURE__*/buildPairAddresses([[// TRX/USDT
...
'0xA73FB788C5A6EF2BDB5FF621BC06F3CC8FF01A2A', '0x50ED1A4BD6335F1FE3570A4C167EF0A765817F67', '0x4C6A66126A7B3271DCDC1B07C84AB83EEFD1092B'], [// HKMC/USDT
'0x50ED1A4BD6335F1FE3570A4C167EF0A765817F67', '0xD7377F28E13C4B255CD532E8182C0EF0F332E33F', '0x484809750F039BF7A181C7D9367C46E7914A62D4'], [// HKMC/ETH
'0x50ED1A4BD6335F1FE3570A4C167EF0A765817F67', '0x4D59F65BA2D66D80F321E66BE5DF152E71AA302F', '0x6016298F7AD4426B20485BE35CA289EA01A02AD0'], [// HKMC/BTC
'0x50ED1A4BD6335F1FE3570A4C167EF0A765817F67', '0x0B511B28D410B729D9D1502445FC1DAFE3B52810', '0xF0207A39AB5BB096039B953B9A84AE056A03E9CE'], [// HKMC/BTC
'0x0B511B28D410B729D9D1502445FC1DAFE3B52810', '0xD7377F28E13C4B255CD532E8182C0EF0F332E33F', '0x18430F57E0EC53BBB7146572258B46D000328243'], [// HKMC/BTC
'0x0B511B28D410B729D9D1502445FC1DAFE3B52810', '0x4D59F65BA2D66D80F321E66BE5DF152E71AA302F', '0x9857C2C3C765140342DA51A7231BE2726A04C96D'], [// ETH/USDT
'0x4D59F65BA2D66D80F321E66BE5DF152E71AA302F', '0xD7377F28E13C4B255CD532E8182C0EF0F332E33F', '0x3B7E6AEA4ACF5D7884D847411F23B18C0EA62E39']]), _PAIR_ADDRESSES);
...
var logger = /*#__PURE__*/new Logger(version);
...
Currency.ETHER = /*#__PURE__*/new Currency(6, 'TRX', 'Tron');
...
var WETH = (_WETH = {}, _WETH[ChainId.MAINNET] = /*#__PURE__*/new Token( // Deployed by Tron Foundation
// https://tronscan.io/#/token20/TNUC9Qb1rRpS5CbWLmNMxXBjyFoydXjWFR/code
ChainId.MAINNET, '0x891cdb91d149f23b1a45d9c5ca78a88d0cb44c18', 6, 'WTRX', 'Wrapped TRX'), _WETH[ChainId.NILE] = /*#__PURE__*/new Token(ChainId.NILE, '0xfb3b3134f13ccd2c81f4012e53024e8135d58fee', 6, 'WTRX', 'Wrapped Tron'), _WETH[ChainId.SHASTA] = /*#__PURE__*/new Token(ChainId.SHASTA, '0xb970b980c520ec3f49921c2727bfa6de79e7226a', 6, 'WTRX', 'Wrapped Tron'), _WETH);
  ...
  */
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$t = _PAIR_ADDRESS_CACHE[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE$t === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$t[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE2 = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE2[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = getCreate2Address(FACTORY_ADDRESSES[tokenA.chainId], keccak256$1(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASHES[tokenA.chainId]), _extends2)), _extends3));
    }
...
export { ChainId, Currency, CurrencyAmount, ETHER, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WETH, currencyEquals, inputOutputComparator, tradeComparator };
